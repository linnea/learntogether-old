...
INSERT INTO "Users" (name, email, password, "isAdmin", "createdAt", "updatedAt") VALUES ('root', 'root', '$2a$08$qOepzilN.F074dhepDHv8unJ2VWqBj9ctMCKUwqwrvad1.Qsd2Pcu', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
